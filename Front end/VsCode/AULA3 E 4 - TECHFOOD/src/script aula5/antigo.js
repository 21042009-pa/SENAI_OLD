...
console.log("2. O primeiro card da lista:", listaCards[0]); /*seleção do card que eu quero mostrar */
console.log("3. A lista completa de links:", links);
console.log("4. O endereço (URL) do primeiro link:", links[0].href); /*.href = motrar o endereço */
console.log("5. A cor do cabeçalho:", topo.style.backgroundColor); /*que definimos*/
